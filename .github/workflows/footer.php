        ...
        <div class="card text-center">
            <div class="card-header  " >
                <div class="row text-center">
                    ...
                    Follow us:
                    <img class="media" src="image/facebook.png" alt="Facebook">
                    <img class="media" src="image/lin.png" alt="Linkedin">
                    <img class="media" src="image/insta.png" alt="Instagram">
                    <img class="media" src="image/twitter.jpg" alt="Twitter">
